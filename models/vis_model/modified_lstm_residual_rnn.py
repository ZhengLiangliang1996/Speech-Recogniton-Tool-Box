...
class brnn_keras(object):
    ...
    def make_residual_lstm_layers(self, input1, rnn_width, rnn_depth, rnn_dropout):
        x = input1
        for i in range(4):
    ...
    def model_init(self, args):
        ...
        if self.args.is_brnn == '123':
            ...
            if self.args.rnn_celltype == 'gru':
                ...
                bidir_rnn = self.make_residual_lstm_layers(self.inputs, self.args.hidden_size,self.args.num_layers, self.args.keep_prob)
