...
train_filenames, test_filenames, dev_filenames = split_ratio(feature_folder_path, 0.8, 0.1, 0.1)
# copy file 

# Train
train_feature_path = '../samples/cha/stimuli3/0/feature_train/'
...
# Get splited file name 
train_filenames_label, test_filenames_label, dev_filenames_label = split_ratio(label_folder_path, 0.8, 0.1, 0.1)
# copy file 
...
copy_file(train_filenames_label, feature_folder_path, train_label_path)
copy_file(test_filenames_label, feature_folder_path, test_label_path)  
copy_file(dev_filenames_label, feature_folder_path, dev_label_path)
