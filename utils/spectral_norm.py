...
def spectral_normed_weight(w, 
    ...
    if u is None:
        u = tf.compat.v1.get_variable("u_vec", [w_new_shape[0], 1], initializer=tf.compat.v1.truncated_normal_initializer(), trainable=False)
    ...
    update_u_op = tf.compat.v1.assign(u, u_final)
